...
public class CourseService {
	 ...
	 HashMap<String, Student> students = new HashMap<>();
	    ...
	    HashMap<String, String> enroled = new HashMap<String, String>();
	    ...
	    public void enrollStudent(String studentId, String courseId){
	    	...
	    	enroled.put(studentId, courseId);
	    	
	    	System.out.println("Agregado");
	    	System.out.println(enroled);
	    }

	    public void unEnrollStudent(String studentId, String courseId){
	        //TODO implement so it removes the given course form the student
	    	enroled.remove(studentId,courseId);
	    	System.out.println(enroled +" borrado");
	    }
